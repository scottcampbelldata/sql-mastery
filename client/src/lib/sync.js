...
export function getSyncCode() { return safeGet(SYNC_CODE_KEY) || ''; }
export function setSyncCodeValue(code) { safeSet(SYNC_CODE_KEY, code); }
export function clearSyncCode() { try { localStorage.removeItem(SYNC_CODE_KEY); } catch { /* ignore */ } }
...
async function apiPut(code, data) {
...
export async function pullMergePush(code) {
...
export async function pushIfChanged(code) {
