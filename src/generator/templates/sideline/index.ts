...
const caseExpressionTemplates: Template[] = [
  ...
  sidelineTemplate({
    ...
    ...sortBy('player', 'player_id'),
    phrasings: [
      'Label each player by earnings_band and return player_id, handle, earnings_band. Order by player_id.',
      'Use CASE on total_earnings_usd to bucket every player as player_id, handle, earnings_band, ordered by player_id.',
    ],
  ...
  sidelineTemplate({
    ...
    ...sortBy('tournament', 'tournament_id'),
    phrasings: [
      'Label each tournament by prize_band and return tournament_id, name, prize_band. Order by tournament_id.',
      'Use CASE on prize_pool_usd to bucket tournaments as tournament_id, name, prize_band, ordered by tournament_id.',
    ],
  ...
  sidelineTemplate({
    ...
    phrasings: [
      'Label each match format and return match_id, stage, format_label. Order by match_id.',
      'Use CASE on best_of to return match_id, stage, format_label for every match, ordered by match_id.',
    ],
  ...
  sidelineTemplate({
    ...
    phrasings: [
      'Label each sponsor contract as contract_status and return team_id, sponsor_id, contract_start, contract_status. Order by team_id, sponsor_id, contract_start.',
      'Use CASE on contract_end to return team_id, sponsor_id, contract_start, contract_status, ordered by team_id, sponsor_id, contract_start.',
    ],
...
const subqueryInTemplates: Template[] = [
  ...
  sidelineTemplate({
    ...
    phrasings: [
      'List regions that have at least one elite-Elo team. Return region_id and region_name. Order by region_id.',
...
const scdAsofTemplates: Template[] = [
  ...
  sidelineTemplate({
    ...
    ...withSort([{ name: 'topN', kind: 'limit' }], 'roster_change', 'roster_change_id'),
    phrasings: [
      'Find roster stints active on each player signed_date and return {topN} roster_change_id, player_id, team_id, signed_date rows. Order by roster_change_id.',
      'Join roster_change to player and use signed_date as the as-of date, returning {topN} rows ordered by roster_change_id.',
    ],
